    ...
    <section className="bg-marca-crema py-16">
      <div className="container mx-auto px-4 text-center">
        ...
        <p className="text-[length:var(--text-body-lg)] text-marca-gris max-w-3xl mx-auto leading-relaxed">
          ...
          y crear juntos esa idea loca que tenés en mente. Ya sea una boda, un
          cumple de 15, o el primer añito de tu bebé, estamos acá para que cada
          detalle cuente. ¡Todo es 100% personalizado!
        </p>
      </div>
    </section>
  );
